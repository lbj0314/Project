...
public final class SendSMS {
    ...
    public static void main(String[] args) {
    	...
    	sms("마닐라-여행","01037906830");

    }
    
    public static void sms(String content,String receiver) {
    	
    	String appid = "AppKey";
    	String apikey = "e5dfd64a8c6711e78a940cc47a1fcfae";
    	//public static final String content = "나는 유리를 먹을 수 있어요. 그래도 아프지 않아요";
    	String content1 = "주문하신 ";
    	String content2 = "패키지가 주문 완료되었습니다.";
    	String sender = "01037906830";
    	//String receiver = "01037906830";

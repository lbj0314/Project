...
public class StayDTO {
	...
	public void setStayGoods(int stayGoods) {
		this.stayGoods = stayGoods;
	}
	...
	public String getStayImageClone() {
		return stayImageClone;
	}
	...
	public String toString() {
		return "StayDTO [stayNum=" + stayNum + ", stayName=" + stayName + ", stayImage=" + stayImage + ", stayPhone="
				+ stayPhone + ", stayLocation=" + stayLocation + ", stayGrade=" + stayGrade + ", stayKidPrice="

...
(
	...
	-- 사용자 이메일
	COMMEMAIL varchar2(40) NOT NULL,
	-- 사용자 주소1
...
(
	...
	-- GOOD_PACKAGE 결제 종류
	GOPAYMENT varchar2(10) NOT NULL,
...
(
	...
	PAKID number(3,0),
	-- ORDER_PACKAGE 보증금
	PADEPOSIT varchar2(20),
	-- ORDER_PACKAGE 결제 날짜
	PAWRITEDAY date DEFAULT SYSDATE,
	-- PACKAGE 결제 종류
	PAPAYMENT varchar2(20),
...
(
	...
	RESTNUM number(4,0) NOT NULL,
	-- 음식점 종류
	RESTTYPE varchar2(20) NOT NULL,
	-- 음식점 이름
	RESTNAME varchar2(20) NOT NULL,
	-- 음식점 지역위치
	RESTLOCATION varchar2(20) NOT NULL,
	-- 음식점 가격
...
(
	...
	STAYNUM number(7,0) NOT NULL,
	-- 숙박업소 종류
	STAYTYPE varchar2(20 char) NOT NULL,
	-- 숙박업소 이름
	STAYNAME varchar2(20 char) NOT NULL,
	-- 숙박업소 지역위치
	STAYLOCATION varchar2(20) NOT NULL,
	-- 숙박업소 등급
...
(
	-- 관광지 종류
	ATTTYPE varchar2(5) NOT NULL,
	-- 관광지 이름
	ATTNAME varchar2(20) NOT NULL,
	-- 관광지 지역위치

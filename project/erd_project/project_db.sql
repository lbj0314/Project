...
DROP TABLE ORDERPACKAGE CASCADE CONSTRAINTS;
DROP TABLE PROJECT.NOTICE CASCADE CONSTRAINTS;
DROP TABLE PROJECT.ADMINISTRATOR CASCADE CONSTRAINTS;
...
(
	...
	-- 업소 분류(관광명소,맛집,숙박업소)
	ORDERCATEGORY varchar2(8),
	-- 업소명
	-- 
	ORDERNAME varchar2(50),
	-- 업소 지역
	-- 
	ORDERLOCATION varchar2(200),
...
(
	...
	-- 관광지 주소
	ATTADDR varchar2(50 char) NOT NULL,
...
ALTER TABLE PROJECT.NOTICE
	...
	REFERENCES PROJECT.ADMINISTRATOR (ADMNUM)
;
...
COMMENT ON COLUMN FESTIVAL.FESNUM IS '축제 번호
';
COMMENT ON COLUMN FESTIVAL.FESNAME IS '축제 이름';
COMMENT ON COLUMN FESTIVAL.FESPHONE IS '축제 전화번호';
COMMENT ON COLUMN FESTIVAL.FESLOCATION IS '축제 지역';
COMMENT ON COLUMN FESTIVAL.FESPRICE IS '축제 가격';
COMMENT ON COLUMN FESTIVAL.FESTITLE IS '축제 제목';
COMMENT ON COLUMN FESTIVAL.FESCONTENT IS '축제 내용';
COMMENT ON COLUMN FESTIVAL.FESWRITEDAY IS '축제 글쓴 날짜';
COMMENT ON COLUMN FESTIVAL.FESREADCNT IS '축제 댓글 수';
COMMENT ON COLUMN FESTIVAL.FESIMAGE IS '축제 이미지';
COMMENT ON COLUMN FESTIVAL.FESIMAGECLONE IS '축제 이미지 중복시';
COMMENT ON COLUMN FESTIVAL.FESSITE IS '축제 사이트';
COMMENT ON COLUMN FESTIVAL.FESSEASON IS '축제 시즌';
COMMENT ON COLUMN FESTIVAL.FESADDR IS '축제 주소';
COMMENT ON COLUMN ORDERPACKAGE.ORDERCATEGORY IS '업소 분류(관광명소,맛집,숙박업소)';
COMMENT ON COLUMN ORDERPACKAGE.ORDERNAME IS '업소명
';
COMMENT ON COLUMN ORDERPACKAGE.ORDERLOCATION IS '업소 지역
';
COMMENT ON COLUMN ORDERPACKAGE.ORDERPHONE IS '업소 전화번호
';
COMMENT ON COLUMN PROJECT.ADMINISTRATOR.ADMNUM IS '관리자 번호';
COMMENT ON COLUMN PROJECT.ADMINISTRATOR.ADMID IS '관리자 아이디';
COMMENT ON COLUMN PROJECT.ADMINISTRATOR.ADMPASSWD IS '관리자 비밀번호';
...
COMMENT ON COLUMN PROJECT.RESTAURANT.RESTADDR IS '음식점 주소';
...
COMMENT ON COLUMN PROJECT.STAY.STAYADDR IS '숙박업소 주소';
...
COMMENT ON COLUMN PROJECT.TOUR.ATTADDR IS '관광지 주소';

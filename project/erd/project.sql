...
(
	...
	-- 사용자 가입날짜
	COMJOINDATE date DEFAULT SYSDATE,
	-- 사용자 이메일
	CMOMEMAIL varchar2(40 char) NOT NULL,
	-- 사용자 주소1
...
(
	...
	-- 기업 등급
	ENTGRADE varchar2(10 char) NOT NULL,
	-- 기업 사업자등록번호
	ENTIN number(12) NOT NULL,
	-- 기업 가입날짜
	ENTJOINDATE date DEFAULT SYSDATE,
	-- 기업 종류
	ENTTYPE varchar2(10 char) NOT NULL,
	-- 기업 주소1
	ENTADDR1 varchar2(20 char) NOT NULL,
	-- 기업 주소2
	ENTADDR2 varchar2(20 char) NOT NULL,
	-- 기업 우편번호1
	ENTPOST1 number(5,0) NOT NULL,
	-- 기업 우편번호2
	ENTPOST2 number(5,0) NOT NULL,
...
(
	...
	-- 관광지 BEST
	ATTBEST varchar2(500 char) NOT NULL,
	-- 관광지 이미지
...
COMMENT ON COLUMN PROJECT.ADMINATOR.ADMGRADE IS '관리자 등급';
...
COMMENT ON COLUMN PROJECT.COMMEMBER.COMJOINDATE IS '사용자 가입날짜';
COMMENT ON COLUMN PROJECT.COMMEMBER.CMOMEMAIL IS '사용자 이메일';
...
COMMENT ON COLUMN PROJECT.ENTMEMBER.ENTGRADE IS '기업 등급';
COMMENT ON COLUMN PROJECT.ENTMEMBER.ENTIN IS '기업 사업자등록번호';
COMMENT ON COLUMN PROJECT.ENTMEMBER.ENTJOINDATE IS '기업 가입날짜';
COMMENT ON COLUMN PROJECT.ENTMEMBER.ENTTYPE IS '기업 종류';
COMMENT ON COLUMN PROJECT.ENTMEMBER.ENTADDR1 IS '기업 주소1';
COMMENT ON COLUMN PROJECT.ENTMEMBER.ENTADDR2 IS '기업 주소2';
COMMENT ON COLUMN PROJECT.ENTMEMBER.ENTPOST1 IS '기업 우편번호1';
COMMENT ON COLUMN PROJECT.ENTMEMBER.ENTPOST2 IS '기업 우편번호2';
...
<<<<<<< HEAD
COMMENT ON COLUMN PROJECT.RESTAURANT.RESTREPLECNT IS '음식점 댓글수';
=======
...
COMMENT ON COLUMN PROJECT.TOUR.ATTBEST IS '관광지 BEST';

	...
	$(document).ready(function() {
		$('#name').keyup(function() {
		 ...
		 if ($('#name').val().length < 2 ) {
				...
				$('font[name=check]').text("영문 또는 한글 2-6자리로 입력해주세요");
				}
			  else {
	...
	$(document).ready(function() {
		$('#id').keyup(function() {
		 ...
		 if ($('#id').val().length < 2 ) {
				...
				$('font[name=check2]').text("영문 또는 한글 2-6자리로 입력해주세요");
				}
			  else {
		...
		$('#passwd').keyup(function() {
		 ...
		 if ($('#passwd').val().length < 8 ) {
				...
				$('font[name=check3]').text("8자리 이상으로 입력하세요");
				}
			  else {
		...
		$('#passwd2').keyup(function() {
			if ($('#passwd').val() != $('#passwd2').val()) {
				...
				$('font[name=check4]').text("암호가 맞지 않습니다");
			}
			else {
				$('font[name=check4]').css("color", "blue");
				$('font[name=check4]').text("암호가 일치합니다");
			}
		});
	});//passwd
	...
	$(document).ready(function() {
		$('#phone1').keyup(function() {
			if ($('#phone1').val().length < 10) {
				...
				$('font[name=check6]').text("숫자 10-11자리로 입력해주세요");
			}
			else {
	...
	<table border='1'>
		...
		<tr>
			...
			<td><input type="text" placeholder="휴대폰 번호(-제외)" id="phone1"
				name="phone1" maxlength="11"><font name="check6" size="2"></font></td>
		</tr>
		<tr>
			<td>이메일 주소</td>

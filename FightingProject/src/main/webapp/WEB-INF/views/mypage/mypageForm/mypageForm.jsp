...
<a href="/test/ReservLeave" class="btn btn-default">다녀온 패키지</a> <!-- 여기에 다녀온패키지와 연관해서 작성된 후기 바로가는 버튼링크 달기 -->
...
<a href="memberManage" class="btn btn-default">회원 관리하기</a>
<a href="reviewManage" class="btn btn-default">후기글 관리하기</a>
</c:if>

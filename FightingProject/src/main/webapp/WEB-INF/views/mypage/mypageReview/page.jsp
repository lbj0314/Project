<%@page import="com.dto.review.ReviewPageDTO"%>
...
<c:if test="${curPage != 1}">
	<a
		href='reviewList?curPage=1&searchName=${searchName}&searchValue=${searchValue}' class="btn btn-primary btn-sm active" role="button">처음</a>
&nbsp;
</c:if>
...
<c:if test="${startPage != 1}">
	<a
		href='reviewList?curPage=${startPage -1}&searchName=${searchName }&searchValue= ${searchValue}' class="btn btn-primary btn-sm active" role="button">&lt;&lt;</a>
...
<c:if test="${curPage != 1}">
	<a
		href='reviewList?curPage=${curPage -1}&searchName=${searchName}&searchValue=${searchValue}' class="btn btn-primary btn-sm active" role="button">&lt;</a>
...
<a href="#" class="btn btn-primary btn-sm disabled" role="button">${aa}</a>
	...
	<c:if test="${curPage != aa}">
		<a
			href='reviewList?curPage=${aa}&searchName=${searchName }&searchValue=${searchValue }' class="btn btn-primary btn-sm active" role="button">${aa}</a> 
		&nbsp;
		</c:if>
</c:forEach>
...
<c:if test="${curPage != endPage }">
	<a
		href='reviewList?curPage=${endPage }&searchName=${searchName }&searchValue=${searchValue}' class="btn btn-primary btn-sm active" role="button">${endPage}</a>
...
<c:if test="${endPage != totalNum }">
	<a
		href='reviewList?curPage=${endPage +1 }&searchName=${searchName }&searchValue= ${searchValue }' class="btn btn-primary btn-sm active" role="button">&gt;&gt;</a>
</c:if>
&nbsp;
<c:if test="${curPage == totalNum }">
...
<c:if test="${curPage != totalNum }">
	<a
		href='reviewList?curPage=${totalNum}&searchName=${searchName }&searchValue=${searchValue }' class="btn btn-primary btn-sm active" role="button">마지막</a>
</c:if>

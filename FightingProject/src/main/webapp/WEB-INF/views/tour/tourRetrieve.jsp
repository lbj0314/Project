...
$(document).ready(function() {
		...
		var RegName = /^[가-힣a-zA-Z0-9_-]{1,20}$/; //이름 유효성 검사 2~20자 사이
		var RegTitle =  /^[가-힣a-zA-Z0-9_-]{1,30}$/;  //제목 유효성 검사 4~30자 사이
	...
	$(document).ready(function() {
		$('#attName').keyup(function() {
		 if ($('#attName').val().length < 1 ) {
				$('font[name=check]').css("color", "red");
				$('font[name=check]').text("관광지 이름에 1~20자로 입력해주세요.");
				}
			  else {

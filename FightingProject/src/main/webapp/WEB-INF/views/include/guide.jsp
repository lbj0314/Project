...
<body>
	...
	<h4>
		관광명소에 대해 지역별은 물론 <br> 자연, 체험, 역사, 테마, 쇼핑 별로 보실 수 있습니다
	</h4>
	<br>
	<a href="/test/tourList"><img
		src="/test/images/guide/tourguide.jpg" width="500px" height=* /></a>
	<br>
	<a href="/test/tourList">관광명소에 대한 정보를 보시려면 그림이나 여기를 클릭!</a>
	<br>
	<br>
	<br>
	<br>
	...
	<br>
	<h4>
		맛집에 대해서도 지역별은 물론 <br> 한식, 일식, 중식, 양식, 패스트푸드, 제과 별로 보실 수 있습니다
	</h4>
	<br>
	...
	<br>
	<h4>
		숙박에 대한 선택권도 다양합니다<br> 지역별 / 게스트하우스, 아파트, 모텔, 호텔, 호스텔, 펜션, 홈스테이,
		템플 스테이로 분류되어 있습니다.
	</h4>
	<br>
	...
	<br>
	<h4>
		숙박, 음식점, 관광명소에 대한 정보를 볼 수 있을 뿐만 아니라 <br> 마음에 드는 곳을 선택하신 후 <br>
		자유롭게 패키지를 설정하실 수 있습니다
	</h4>
	<br>
	<br>
	<br>
	...
	<br>
	<br> 회원가입은
	<a href="#top">오른쪽 상단</a>에서 하실 수 있습니다
	<br>
	<br> 관광명소, 음식점, 숙박업소를 운영중이신 경우
	<br> 직접 자신의 업체를 등록하실 수 있습니다
	<br> 문의사항은 010-0000-0000 이나 QnA 게시판에 남겨주시면 답변 드립니다
	<br>
	<br>
	<br>
	<br>

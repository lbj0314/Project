...
CREATE SEQUENCE PROJECT.ADMINATOR_SEQ INCREMENT BY 1 MINVALUE 0 MAXVALUE 999 START WITH 6 NOCACHE;
CREATE SEQUENCE PROJECT.COMMEMBER_SEQ INCREMENT BY 1 MINVALUE 0 MAXVALUE 999 START WITH 8 NOCACHE;
CREATE SEQUENCE PROJECT.ENTMEMBER_SEQ INCREMENT BY 1 MINVALUE 0 MAXVALUE 999 START WITH 20 NOCACHE;
...
CREATE SEQUENCE PROJECT.PACKLIST_SEQ INCREMENT BY 1 MINVALUE 0 MAXVALUE 999 START WITH 59 NOCACHE;
CREATE SEQUENCE PROJECT.PACKORDER_SEQ INCREMENT BY 1 MINVALUE 0 MAXVALUE 999 START WITH 51 NOCACHE;
CREATE SEQUENCE PROJECT.RESTAURANT_SEQ INCREMENT BY 1 MINVALUE 0 MAXVALUE 999 START WITH 29 NOCACHE;
CREATE SEQUENCE PROJECT.STAY_SEQ INCREMENT BY 1 MINVALUE 0 MAXVALUE 999 START WITH 17 NOCACHE;
CREATE SEQUENCE PROJECT.TEST_SEQ INCREMENT BY 1 MINVALUE 0 MAXVALUE 999 START WITH 14 NOCACHE;
CREATE SEQUENCE PROJECT.TOUR_SEQ INCREMENT BY 1 MINVALUE 0 MAXVALUE 999 START WITH 83 NOCACHE;
...
(
	ORDERNUM number(4,0) NOT NULL,
	-- 업소 분류(관광명소,맛집,숙박업소)
	ORDERCATEGORY varchar2(8 char),
	-- 업소명
	-- 
	ORDERNAME varchar2(50 char),
	-- 업소 지역
	-- 
	ORDERLOCATION varchar2(200 char),
	ORDERTYPE varchar2(50 char),
	ORDERADULTPRICE number(20),
	-- 업소 전화번호
	-- 
	ORDERPHONE number(20),
	CONSTRAINT SYS_C0011800 PRIMARY KEY (ORDERNUM)
);
...
(
	...
	PACKNAME varchar2(500 char) NOT NULL,
	ADULT number(4,0) NOT NULL,
	KID number(4,0) NOT NULL,
	PAYMENT varchar2(30 char) NOT NULL,
...
ALTER TABLE PROJECT.PACKLIST
	ADD FOREIGN KEY (COMNUM)
	REFERENCES PROJECT.COMMEMBER (COMNUM)
;


ALTER TABLE PROJECT.PACKORDER
	ADD FOREIGN KEY (COMNUM)
	REFERENCES PROJECT.COMMEMBER (COMNUM)
;
...
COMMENT ON COLUMN PROJECT.ORDERPACKAGE.ORDERCATEGORY IS '업소 분류(관광명소,맛집,숙박업소)';
COMMENT ON COLUMN PROJECT.ORDERPACKAGE.ORDERNAME IS '업소명
';
COMMENT ON COLUMN PROJECT.ORDERPACKAGE.ORDERLOCATION IS '업소 지역
';
COMMENT ON COLUMN PROJECT.ORDERPACKAGE.ORDERPHONE IS '업소 전화번호
';
COMMENT ON COLUMN PROJECT.PACKLIST.COMNUM IS '사용자 번호';
COMMENT ON COLUMN PROJECT.PACKORDER.COMNUM IS '사용자 번호';
